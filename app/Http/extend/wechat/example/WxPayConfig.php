...
* 
**/
namespace App\Http\extend\wechat\example;
use App\Http\extend\core\helper\SysHelper;
use App\Http\extend\wechat\lib\WxPayConfigInterface;
...
class WxPayConfig extends WxPayConfigInterface
{
    ...
    {
        $this->config = [
            'key'=> 'a3d45dca15b42197505a3a82ec27df13',
            'mch_id'=> '1481085892',
            'app_id'=> 'wx607565cee30facf0',
            'secret'=> '10496c52bfdbc4fc717608fc40f1dd37'
        ];
    }
    //=======【基本信息设置】=====================================
	/**
