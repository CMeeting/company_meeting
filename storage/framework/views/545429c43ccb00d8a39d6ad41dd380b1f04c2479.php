        ...
        <div class="col-md-12">
            <div class="portlet light ">
                <div class="portlet-title tabbable-line">
                    <div class="actions">
                        <a id="cc" class="addClassify btn btn-md  blue  dropdown-toggle mt-ladda-btn ladda-button" data-style="zoom-in"  type="button" href="<?php echo e(route('documentation.createSdkClassification')); ?>">
            ...
            <script>
                function level(id){
                    layer.confirm('您确定要调整层级关系吗？', {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('documentation.update_leve')); ?>",
                ...
                function del(id){
                    layer.confirm('您确定要删除吗？', {
                        ...
                        var index = layer.load();
                        $.ajax({
                            url: "<?php echo e(route('documentation.delSdkclassification')); ?>",
                ...
                function show(id){
                    ...
                    $.ajax({
                        ...
                        data: {id:id,type:'sdk_classification', _token: '<?php echo e(csrf_token()); ?>'},
                        type: 'post',
                        dataType: "json",
                        success: function (resp) {
                            if (resp.code==0) {
