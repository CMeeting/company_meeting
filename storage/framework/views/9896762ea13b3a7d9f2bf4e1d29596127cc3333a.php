        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header text-center">
                <div class="dropdown profile-element" style="margin-top: 15px">
                                <span>
                                    <img alt="image" class="img-circle" src="<?php echo e($admin->avatr); ?>" width="64" height="64"/>
                                </span>
            ...
            <?php $__currentLoopData = Auth::guard('admin')->user()->getMenus(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($rule['route'] == 'index.index'): ?>
                    <li>
                        <a title="<?php echo e($rule['name']); ?>" href="<?php echo e(route($rule['route'])); ?>" target="_self">
