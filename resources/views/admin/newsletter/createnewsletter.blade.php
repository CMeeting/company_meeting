    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-title">
                <h5>New Newsletter</h5>
            </div>
            <div class="ibox-content">
                <a href="{{route('newsletter.newsletter_list')}}" style="margin-bottom: 8px">
                    <button class="menuid btn btn-primary btn-sm back" type="button"><i class="fa fa-chevron-left"></i> 返回列表
                    </button>
                </a>
                <form class="form-horizontal" id="forms" name="form"  method="post" action="{{route('newsletter.createrunnewsletter')}}" >
                    {{ csrf_field() }}
...
{{--                    </div>--}}
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> name(电子报模板名称)：</label>
                        <div class="col-sm-6 col-xs-12">
                            <input id="name"  class="form-control" name="data[name]" required maxlength="255">
                            <span class="lbl"></span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 电子报标题：</label>
                        <div class="col-sm-6 col-xs-12">
                            <input id="title"  class="form-control" name="data[title]" required maxlength="255">
                            <span class="lbl"></span>
                        </div>
                    </div>

                    <div class="form-group tinyeditor">
                        <label class="col-sm-2 control-label no-padding-right" for="form-field-1"> content(电子报内容)：</label>
    ...
    table image media charmap emoticons hr pagebreak insertdatetime print preview | fullscreen | bdmap indent2em lineheight axupimgs',
        ...
        function submits(){
            ...
            $.ajax({
                url:"{{route('newsletter.createrunnewsletter')}}",
