    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" id="forms" name="form"  method="post" action="{{route('newsletter.updaterunsubscription')}}" >
                    {{ csrf_field() }}
<input type="hidden" name="data[id]" value="{{$data['id']}}">
                    ...
                    <div class="form-group" style="margin-top: 20px">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <input id="name"  class="form-control" name="data[email]" required maxlength="255" value="{{$data['email']}}">
                            <span class="lbl"></span>
                        </div>
                    </div>
...
{{--                        <div class="col-sm-6 col-xs-12">--}}
{{--                            <input type="radio" name="data[status]" value="1" @if($data['status']==1) checked @endif>订阅状态--}}
{{--                            <input type="radio" name="data[status]" value="0" @if($data['status']==0) checked @endif>取消订阅--}}
{{--                        </div>--}}
{{--                    </div>--}}
    ...
    <script>
        ...
        function submits(){
            ...
            $.ajax({
                url:"{{route('newsletter.updaterunsubscription')}}",
