                    ...
                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <input id="displayorder"  class="form-control" name="displayorder" min="1" max="99999999" oninput="if(value.length>8)value=value.slice(0,8)" required>
                                        <span class="lbl"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <select name="pid" class="form-control sels"  id="selectid" @if(isset($pid) && $pid) style="pointer-events: none;color: #9f9f9f" @endif>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <input id="name"  class="form-control" name="name" required min="1" max="99999999" onKeyUp="value=value.replace(/[^\w\.\/-]/ig,'')">
                                        <span class="lbl"></span>
                                    </div>
                                </div>
                                ...
                                @if(isset($pid) && $pid == 0)
                                    ...
                                    <div class="form-group h1title">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <input id="seotitel"  class="form-control  seotitel" name="seotitel" required placeholder="SEO title只会绑定在平台数据">
                                            <span class="lbl"></span>
                                        </div>
                                    </div>
                                    <div class="form-group h1title">
                                        ...
                                        <div class="col-sm-6 col-xs-12">
                                            <input id="h1title"  class="form-control " name="h1title" required placeholder="H1 title只会绑定在平台数据">
                                            <span class="lbl"></span>
                                        </div>
                                    </div>
                                @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <input type="radio" name="enabled" value="1" checked >显示
