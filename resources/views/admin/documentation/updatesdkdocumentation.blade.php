            ...
            <div class="ibox-content">
                <form class="form-horizontal" name="form"  method="post" action="{{route('documentation.updateRunsdkDocumentation')}}" >
                    ...
                    <div class="form-group h1title">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <input id="seotitel"  class="form-control  seo_description" name="data[seo_description]" value="{{$data['seo_description']}}" required>
                            <span class="lbl"></span>
                        </div>
                    </div>
                    <div class="form-group h1title">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <select class="form-control" name="data[type]" id="type" style="pointer-events: none;color: #9f9f9f">
                                <option value="1" @if($data['type']==1) selected @endif>富文本编辑器</option>
                                <option value="2" @if($data['type']==2) selected @endif>MarkDown编辑器</option>
                            </select>
                        </div>
                    </div>
