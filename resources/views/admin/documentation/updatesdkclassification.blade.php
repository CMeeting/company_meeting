    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-title">
                <h5>Edit SDK Guides</h5>
            </div>
            <div class="ibox-content">
                <form class="form-horizontal" name="form"  method="post" action="{{route('documentation.updateRunSdkclassification')}}" >
                    {{ csrf_field() }}
       <input type="hidden" name="data[id]" value="{{$data['id']}}">
                    ...
                    <textarea id="testt123" style="display: none">{{$parent}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <select name="data[pid]" class="form-control sels"  id="selectid" @if(isset($data['pid']) && $data['pid']=='0') style="pointer-events: none;color: #9f9f9f" @endif>
