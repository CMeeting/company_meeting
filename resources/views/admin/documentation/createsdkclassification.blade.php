        ...
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                <form class="form-horizontal" name="form"  method="post" action="{{route('documentation.createRunPlatformVersion')}}" >
                    ...
                    <?php $parents = json_encode($parent);?>
                    <textarea id="testt" style="display: none">{{$parents}}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <select autocomplete="off" class="fenlei form-control ccs" id="category_child" name="data[version]"  style="pointer-events: none;color: #9f9f9f">
                            </select>
                            @else
                            ...
                            <select autocomplete="off" class="fenlei form-control ccs" id="category_child" name="data[version]"  style="display: none">
...
<script language="javascript">
    var c=$("#testt").text();
    var $categroys = JSON.parse(c);
    var defaultpcate = parseInt("{{$data['platformid']}}");
    var defaultccate = parseInt("{{$data['version']}}");
