            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" id="forms" name="form"  method="post" action="{{route('goods.updaterungoods')}}" >
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="data[level2]" id="city" class="cc">
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select name="data[level3]" id="town" class="cc">
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <input id="price"  type="number" class="form-control" name="data[price]" min="0.01" max="99999999" step="0.01" oninput="if(value.length>8)value=value.slice(0,8)" value="{{$data['price']}}" required>
