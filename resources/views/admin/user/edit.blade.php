                ...
                <form class="form-horizontal m-t-md" id="form_data" accept-charset="UTF-8" enctype="multipart/form-data" style="width: 600px;overflow: auto;margin: 0 auto;">
                    ...
                    <div class="form-group" style="padding-left: 18px;">
                        <div class="input-group col-sm-2">
                            <input type="text" class="form-control" name="email" value="{{$row->email}}" required data-msg-required="邮箱必填" style="width: 500px"/>
                        </div>
                    </div>
                    <span style="color: red;font-size: 14px">*</span>
                    ...
                    <div class="input-group col-sm-2">
                        <input type="text" class="form-control" name="full_name" value="{{$row->full_name}}" required data-msg-required="Full Name必填" style="width: 500px"/>
                    </div>
                    ...
                    <div class="form-group" style="margin-top: 20px;">
                        <div class="col-sm-12 col-sm-offset-2">
                            ...
                            <a href="{{route('user.resetPassword', $row->id)}}"><button class="btn btn-danger" type="button" style="margin-left: 30px"><i class="layui-icon layui-icon-password"></i>重置密码</button></a>
                        </div>
                    </div>
