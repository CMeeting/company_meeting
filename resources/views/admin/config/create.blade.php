...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content">
            ...
            <a href="{{route('config.index')}}"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> {{$showKeyArr[$checkKey]}}</button></a>
            ...
            <form class="form-horizontal m-t-md" action="{{ route('config.opeary',$item?$item['id']:0) }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label">{{$showKeyArr[$checkKey]}}ID：</label>
                    <div class="input-group col-sm-2">
                        <input type="text" class="form-control" name="type" value="{{$item?$item['type']:""}}" required data-msg-required="请输入{{$showKeyArr[$checkKey]}}ID">
                        @if ($errors->has('type'))
                ...
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">{{$showKeyArr[$checkKey]}}名称：</label>
                    <div class="input-group col-sm-2">
                ...
                <input type="hidden" class="form-control"  name="key" value="{{$checkKey}}">
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <div class="form-group">
