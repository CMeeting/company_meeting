...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <div class="ibox-content">
                ...
                <form class="form-horizontal" id="forms" name="form"  method="post" action="{{route('mailmagicboard.createrunmailmagic')}}" >
                    {{ csrf_field() }}
    ...
    table image media charmap emoticons hr pagebreak insertdatetime print preview | fullscreen | bdmap indent2em lineheight axupimgs',
        ...
        function submits(){
            ...
            $.ajax({
                url:"{{route('mailmagicboard.createrunmailmagic')}}",
