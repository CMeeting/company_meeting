    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="ibox-title">
                <h5>Edit SaaSGoodsclassification</h5>
            </div>
            <div class="ibox-content">
                <form class="form-horizontal" name="form"  method="post" action="{{route('goodsclassification.updatesaasRungoodsclassification')}}" >
                    {{ csrf_field() }}
                        ...
                        <div class="col-sm-6 col-xs-12">
                            ...
                            <span class="lbl"></span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        <select name="data[pid]" class="form-control sels"  id="selectid" @if(isset($data['id'])) style="pointer-events: none;color: #9f9f9f" @endif>
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    <a class="menuid btn btn-primary btn-sm" href="{{route('goodsclassification.sdkindex')}}">返回</a>
                                </div>
                            </div>
                    </form>
            </div>
...
<script type="text/javascript">
    ...
    $(function (){
        ...
        if(tishival==0){
            $("#name").attr("placeholder","当前添加的是套餐名称");
        }else{
            tishi=tishi.substring(1);
            $("#name").attr("placeholder","当前添加的是"+tishi+"套餐下级的档位名称");
        }
